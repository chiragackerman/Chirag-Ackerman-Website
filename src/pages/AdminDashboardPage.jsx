...
export default function AdminDashboardPage({ onNavigate }) {
  ...
  const handleOpenAddProduct = () => {
    ...
    setProductFormData({
      ...
      image: '',
      imageUrl: '',
      category: categories[0]?.slug || 'gaming-mice',
      categoryName: categories[0]?.name || 'Gaming Mice',
      platform: 'Amazon',
      storeName: 'Amazon India',
      affiliateUrl: '',
      price: '',
  ...
  const handleOpenEditProduct = (prod) => {
    ...
    setProductFormData({
      ...
      category: prod.category || 'gaming-mice',
      categoryName: prod.categoryName || 'Gaming Mice',
